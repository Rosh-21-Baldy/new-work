...
const problems = [
  ...
  const solutions = [
    { title: "Streamlined Process", description: "Ambak simplifies the loan application process, automating tasks and facilitating communication for faster approvals." },
    ...
    { title: "Wider Lender Network", description: "Ambak is committed to finding the best interest rates across 50+ lenders for your customers, leading to higher conversion rates." }
  ];
...
function LoanInfoSection() {
  return ( 
    ...
    <Row className="align-items-center">
      ...
      <Col md={6} className="text-start">
        <h1 className="fw-bold">
          <span style={{ color: "#F27029" }}>Faster Approvals,</span> <br />
      ...
      <Col md={6} className="text-center">
        <img src="https://ambak.com/_next/image?url=https%3A%2F%2Fstatic.ambak.com%2Fimage%2Finstitution%2Fsoftware-engineer.png&w=1080&q=75" alt="Hero Section" className="img-fluid" style={{ maxHeight: "350px" }} />
      </Col>
    </Row>
  </Container>
    <Container className="py-4 my-4" style={{ backgroundColor: '#e7edfe', borderRadius: '10px' }}>
        ...
        <Col md={6}>
          <Card className="p-3 border-0 shadow-sm">
            <Card.Body>
              ...
              <Card.Text>
                By leveraging technology, Ambak improves the home loan process and provides transparency between home loan providers, builders, and customers.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col md={6}>
          <Card className="p-3 border-0 shadow-sm">
            <Card.Body>
              ...
              <Card.Text>
                Ambak streamlines the home loan process, connecting you with over 50 lenders for faster approvals and happier customers. Boost sales and gain real-time transparency.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
     ...
     <h2 className="text-center mb-4 fw-semibold">Your Problems, Ambak’s Solutions</h2>
